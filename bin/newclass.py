...
def createClassH(path, classname):
    ...
    if not ns:
        return False
    context = ""
    context = context + "#ifndef TINDEX_" + classname.upper() + "_H" + "\n"
    context = context + "#define TINDEX_" + classname.upper() + "_H" + "\n"
    context = context + "" + "\n"
    context = context + "#include <tindex/common/Common.h>" + "\n"
    context = context + "" + "\n"
    context = context + "TINDEX_BEGIN_NAMESPACE(" + ns + ");" + "\n"
    context = context + "" + "\n"
    ...
    context = context + "};" + "\n"
    context = context + "" + "\n"
    context = context + "TINDEX_TYPEDEF_PTR(" + classname +");" + "\n\n"
    context = context + "TINDEX_END_NAMESPACE(" + ns + ");" + "\n"
    context = context + "" + "\n"
    context = context + "#endif //TINDEX_" + classname.upper() + "_H" + "\n"
...
def createClassCPP(path, classname):
    ...
    if (not re.match(".*/test", path)):
        context = context + "#include <tindex/" + hp + "/" + classname + ".h>" + "\n"
    else:
        context = context + "#include <tindex/" + hp + "/test/" + classname + ".h>" + "\n"
    context = context + "" + "\n"
    context = context + "TINDEX_BEGIN_NAMESPACE(" + ns + ");" + "\n"
    context = context + "" + "\n"
